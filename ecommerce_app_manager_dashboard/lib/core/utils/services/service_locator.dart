...
void setupServicesLocator() {
  ...
  getIt.registerLazySingleton<GetUsersRemoteDataSource>(() => GetUsersRemoteDataSource(api: getIt(), cacheHelper: getIt()));
  ...
  getIt.registerLazySingleton<GetUsersRepository>(() => GetUsersRepositoryImple(
        remoteDataSource: getIt(),
        networkInfo: getIt(),
      ));
